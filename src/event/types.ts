...
// Layer 10: Viewport Snapshots

export interface SnapshotViewportPayload {
	generator: string;
...
export type Capture =
	...
	// Layer 10: Viewport Snapshots
	| BaseCapture<"snapshot.viewport", SnapshotViewportPayload>
	// Adapter-specific
...
export type SessionEvent =
	...
	// Layer 10: Viewport Snapshots
	| BaseEvent<"snapshot.viewport", SnapshotViewportPayload>
	// Adapter-specific
